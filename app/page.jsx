    ...
    <>
      <div className={styles.container}>
        <div className={styles.title}>
          <Image src="/icon.png" width={55} height={55} alt="" />
          <div className={styles.title_text}>Incorrect Password</div>
        </div>
      ...
      <footer className={styles.footer}>
        Made with ❤️ by <a href="srijit.co">Srijit</a> for CodeDay Kolkata. Hope
        you guys are enjoying this lol.
      </footer>
    </>
  );
}
